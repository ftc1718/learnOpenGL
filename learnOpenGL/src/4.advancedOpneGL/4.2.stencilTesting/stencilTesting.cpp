...
int main()
{
	...
	Shader shader("src/4.advancedOpneGL/4.2.stencilTesting/stencilTesting.vs", "src/4.advancedOpneGL/4.2.stencilTesting/stencilTesting.fs");
	Shader shaderSingleColor("src/4.advancedOpneGL/4.2.stencilTesting/stencilTesting.vs", "src/4.advancedOpneGL/4.2.stencilTesting/stencilSingleColor.fs");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		// draw floor don't write the floor to the stencil buffer
		glStencilMask(0x00);
