...
int main()
{
	...
	Shader shader("src/4.advancedOpneGL/4.3.blending/blending.vs", "src/4.advancedOpneGL/4.3.blending/blending.fs");
	...
	unsigned int vegetationTexture = loadTexture("../res/textures/grass.png");
