...
int main()
{
	...
	Shader objectShader("src/2.lighting/2.5.lightCasters/object.vs", "src/2.lighting/2.5.lightCasters/test.fs");
	//Shader lightShader("src/2.lighting/2.5.lightCasters/light.vs", "src/2.lighting/2.5.lightCasters/light.fs");
