...
int main()
{
	...
	Shader objectShader("src/2.lighting/2.1.colors/object.vs", "src/2.lighting/2.1.colors/object.fs");
	Shader lightShader("src/2.lighting/2.1.colors/light.vs", "src/2.lighting/2.1.colors/light.fs");
